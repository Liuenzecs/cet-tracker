"""ListeningResult model — stores listening practice results for a session."""
...
class ListeningResult(SQLModel, table=True):
    ...
    # Relationships
    session: "ExamSession" = Relationship(back_populates="listening_results")
